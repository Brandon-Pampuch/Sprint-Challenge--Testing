...
Describe can be used to explain and describe a test or group of tests while it is telling you exactly what that test "should" do.
1. What is the point of `Test Driven Development`? What do you think about this approach?
To sort out exactly what you want your application to do and how it should do it before going in and writing the code. It forces you to think about all possible uses and misuses of you your application
